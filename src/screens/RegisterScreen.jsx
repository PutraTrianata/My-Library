...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (Platform.OS === 'web') {
        // Gunakan alert browser untuk platform web agar notifikasi muncul & navigasi berjalan
        alert('Registrasi Berhasil\n\nAkun Anda telah terdaftar dalam sistem. Silakan melakukan login.');
        navigation.navigate('Login');
      } else {
        // Gunakan Alert native untuk Android/iOS
        Alert.alert('Registrasi Berhasil', 'Akun Anda telah terdaftar dalam sistem. Silakan melakukan login.', [
          { text: 'MENU LOGIN', onPress: () => navigation.navigate('Login') }
        ]);
      }
    } catch (error) {
      const errorMsg = error.message || 'Terjadi kesalahan saat pendaftaran.';
      if (Platform.OS === 'web') {
        alert('Gagal Registrasi: ' + errorMsg);
      } else {
      ...
      >
        ...
        >
          ...
          <Animated.View style={[styles.card, { opacity: fadeAnim }]}>
            ...
            <Text style={styles.cardSubtitle}>Silakan lengkapi data identitas Anda</Text>
            ...
            >
              <Text style={styles.loginLinkText}>
                Sudah memiliki akun? <Text style={styles.loginLinkBold}>Kembali ke Login</Text>
              </Text>
            </TouchableOpacity>
          </Animated.View>
